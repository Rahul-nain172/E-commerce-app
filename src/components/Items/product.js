...
export const Product = () => {
    const handleAddtoCart = useContext(UserContext).handleAddtoCart
    let { name } = useParams();
                ...
                <div class="col">
                    <div className={productstyle.Productinfo}>
                        <div className={productstyle.details}>
                            <p>{obj.Details}</p>
                            <p style={{fontSize:"1.7rem"}}>$&nbsp; {obj.Price} &nbsp;<button type="button" class="btn btn-warning" style={{width:"20rem",fontSize:"1.5rem"}} onClick={()=>handleAddtoCart(obj)}><b>ADD TO CART</b></button></p>
                        </div>
